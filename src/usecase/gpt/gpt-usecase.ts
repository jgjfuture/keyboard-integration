        ...
        const messages: ChatCompletionMessage[] = [
            ...
            },
            {
                ...
                content: `
                    ...
                    2. 文章を後で整理するためのタグ（ハッシュタグのようなものですが、ハッシュは不要です。まずは既存のタグを考慮せずにタグをつけてください。大きなレベルの概念だけでなく、詳細なレベルでタグをつけて構いません。最後に、名寄せできるものがあれば既存のタグに名寄せしておいてください。）
            ...
            },
            {
                role: "assistant",
                content: `
                    ありがとうございます。基本的には既存のタグを考慮せずに詳細にタグを考えて付けます。最後に名寄せをしておきます。
